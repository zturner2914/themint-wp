...
<div class="carousel-wrapper gray-box">
...
.st0{fill:none;stroke:#000000;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;}
              ...
              <p class="carousel-img-text">production<br> support</p>
          </div>
        </li>
      </ol>
    </div>
...
<div class="container">
  <div class="row">
    <div class="col-sm-12 col-md-10 col-lg-9">
      <h2><?php the_field('model_heading'); ?></h2>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="row">
        <div class="col-xs-5 col-sm-2 no-padding">
          <a class="btn-model"><span class="btn-model-text-1">Strategic Plan</span></a>
        </div>
        <div class="col-xs-2 col-sm-1 arrow-1">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/arrow.svg" alt="">
        </div>
        <div class="col-xs-5 col-sm-2 no-padding">
          <a class="btn-model" ><span class="btn-model-text-2">Connections<br/>Plan</span></a>
        </div>
        <div class="col-xs-5 col-xs-offset-7 col-sm-1 col-sm-offset-0 arrow-2">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/arrow.svg" alt="">
        </div>
        <div class="col-xs-5 col-sm-2 no-padding">
          <a class="btn-model-mob"><span class="btn-model-text-2">Content<br/> Distribution</span></a>
          <a class="btn-model-desk"><span class="btn-model-text-2">Content<br/> Creation</span></a>
        </div>
        <div class="col-xs-2 col-sm-1 arrow-3">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/arrow.svg" alt="">
        </div>
        <div class="col-xs-5 col-sm-2 no-padding">
          <a class="btn-model-mob"><span class="btn-model-text-2">Content<br/> Creation</span></a>
          <a class="btn-model-desk"><span class="btn-model-text-2">Content<br/> Distribution</span></a>
        </div>
        <div class="col-xs-5 col-sm-2 col-sm-offset-6 arrow-4">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/arrow.svg" alt="">
        </div>
        <div class="col-xs-5 col-xs-offset-2 col-sm-2 col-sm-offset-1 arrow-5">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/arrow.svg" alt="">
        </div>
        <div class="col-xs-5 col-sm-2 col-sm-offset-6 no-padding">
          <a class="btn-model"><span class="btn-model-text-1">Iteration</span></a>
        </div>
        <div class="col-xs-2 col-sm-1 arrow-6">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/arrow.svg" alt="">
        </div>
        <div class="col-xs-5 col-sm-2  no-padding">
          <a class="btn-model"><span class="btn-model-text-1">Analytics</span></a>
        </div>
      </div>
    </div>
  </div>
...
<div class="container">
  <div class="row">
    <div class="col-sm-12">
      ...
      <p><?php the_field('client_description', false, false); ?></p>
      <div class="row">
        <div class="col-sm-12">
          <?php if( have_rows('clients') ): $count = 0; while ( have_rows('clients') ) : the_row(); if ($count % 4 == 0) { ?>
            <div class="client-logos">
               <?php } ?>
                <a href=""><img src="<?php the_sub_field('client_logo'); ?>" alt=""></a>
                <?php if ($count % 4 == 3) { ?>
                </div>
